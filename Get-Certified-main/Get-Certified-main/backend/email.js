const emails = {
	FORGOT_PASSWORD: (userData) => {
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                                  <tr>
                                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0px;word-break:break-word;">
                                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1;text-align:center;color:#000000;"> <span style="font-size: 30px; color: #4390B1;"><b>Get Certified</b></span> </div>
                                    </td>
                                  </tr>
                                </table>
                              </div>
        ...
        Use the code below and start enjoying Get Certified again by generating a new password.
                                    <br>
                                    <br>
                                    <br>
                                    <p
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                  <tr>
                                    <td align="center" style="font-size:0px;padding:10px;word-break:break-word;">
                                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:center;color:white;">In collaboration with BeingZero</div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      ...
                      <tr>
                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"> <span style="font-weight: bold; font-size: 21px; color: #45474e">
                                ...
                                We are very excited to have you with us! Use the code below to verify your email, and start using Get Certified!
                                <br>
                                <br>
                                <br>
                                <p
                      ...
                      <tr>
                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"> <span style="font-weight: bold; font-size: 21px; color: #45474e">
                                ...
                                We are very excited to have you with us! Use the code URL to verify your email, Get Certified!
                                <br>
                                <br>
                                <a href=${userData.URL}><h1>Click Here<h1></a>
                                <br>
                                <p
                                style="line-height: 1.5; text-align: center; word-break: break-word; font-family: 'Source Sans Pro', Tahoma, Verdana, Segoe, sans-serif; font-size: 14px; mso-line-height-alt: 21px; margin: 0;">
                                <span
                                    ...
                                    Please do not share this code with anyone, Use this PASSKEY to Get Certified for Your Skills.
                        </span> </div>
                        </td>
                      </tr>
                    </table>
